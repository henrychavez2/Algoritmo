...
def caminoCorto(matriz, x, y, inicio):
    filas = len(matriz)
...
#Definir la matrix
#Buscar la ruta con menos y mas costo para llegar del punto I al punto F e imprimir el costo de las dos rutas.
matriz = [
